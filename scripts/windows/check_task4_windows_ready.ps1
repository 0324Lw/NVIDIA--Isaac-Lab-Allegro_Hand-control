...
Write-Host "============================================================"
Write-Host "Allegro Hand Task4 Windows readiness check"
Write-Host "============================================================"
...
$TaskFile = Join-Path $ProjectRoot "src\allegro_rl\tasks\task4\task4_train.py"
...
Write-Host "[OK] Task4 Windows framework check completed."
