...
if [ $# -lt 1 ]; then
  ...
  echo "  bash scripts/ubuntu/eval_task2_skrl.sh logs/task2/<run>/final_checkpoint/allegro_task2_model.pt 1.0"
  exit 1
fi
...
echo "============================================================"
echo "Allegro Hand Task2 TRUE skrl PPO model evaluation"
